...
# fit_model()
models = [RandomForestClassifier(n_estimators=5000, n_jobs=-1, class_weight="balanced",verbose=1), AdaBoostClassifier(n_estimators=5000), BaggingClassifier(n_estimators=5000), ExtraTreesClassifier(n_estimators=5000, n_jobs=-1, class_weight='balanced'), GradientBoostingClassifier(n_estimators=5000)]
for model in models:
    fit_model(model)
